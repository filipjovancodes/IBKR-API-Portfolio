...
This is a repository of my IBKR API implementation with the goal of creating a custom dashboard of portfolio analytics and quantitative trading algorithms. My source code is found in the src directory. 

'positions.csv' is a manual input file to categorize positions until algorithmic position categorization is implemented.
